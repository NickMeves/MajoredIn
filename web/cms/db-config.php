...
$wpdb->add_database(array(
	'host'     => MI_MASTER_HOST.':'.MI_MASTER_PORT,     // If port is other than 3306, use host:port.
	'user'     => MI_MASTER_USER,
	'password' => MI_MASTER_PASSWORD,
	'name'     => MI_MASTER_NAME,
));
 ...
 */
$wpdb->add_database(array(
	'host'     => MI_SLAVE_HOST.':'.MI_SLAVE_PORT,     // If port is other than 3306, use host:port.
	'user'     => MI_SLAVE_USER,
	'password' => MI_SLAVE_PASSWORD,
	'name'     => MI_SLAVE_NAME,
	'write'    => 0,
	'read'     => 1,
	'dataset'  => 'global',
